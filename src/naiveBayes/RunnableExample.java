...
public class RunnableExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("NaiveBayesMarquez/trainingReadySPA.txt")); //leggo i tweet
		...
		BufferedReader reader2 = new BufferedReader(new FileReader("NaiveBayesMarquez/testingPastReadySPA.txt")); //leggo i tweet
