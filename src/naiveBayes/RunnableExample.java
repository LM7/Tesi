...
public class RunnableExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("NaiveBayesVolkswagen/trainingReady.txt")); //leggo i tweet
		...
		BufferedReader reader2 = new BufferedReader(new FileReader("NaiveBayesVolkswagen/testingPastReady.txt")); //leggo i tweet
